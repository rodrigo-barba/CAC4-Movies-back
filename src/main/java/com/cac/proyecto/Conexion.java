...
//             properties.load(Conexion.class.getClassLoader().getResourceAsStream("db.properties"));
    ...
    public Conexion() {
        try {
            ...
            this.connection = DriverManager.getConnection(
                ...
                "mysqlpass01!"  // Contraseña de la base de datos (cambia según tu configuración)
            );
